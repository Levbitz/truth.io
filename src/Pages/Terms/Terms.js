...
function Terms() {
  return (
    <div>
      <Topbanner Bg={DepartOne} title="terms" UrlName="teams and conditions" />
      <div className="container">
        <h2 className="levbitz_title">
          Serpens Technology - Terms and Conditions
        </h2>
              ...
              <div className="row">
                <div className="col l12">
                  ...
                  <p>
                    ...
                    "Our" in this Agreement) refers to Serpens technology pvt
                    ltd, 36 2nd main 2nd cross sampangappa layout pipe line road
                    mathikere Bangalore.
                  </p>
                  <p>
                  ...
                  <p>
                    Website refers to Serpens technology pvt ltd, accessible
                    from serpenstech.com
                  </p>
                  <p>
        ...
        <div className="row">
          <div className="col l12">
            ...
            <p>By email: contact@serpenstech.com</p>
            <p>By visiting this page on our website: https://serpenstech.com</p>
            <p>By phone number: +91 8035846012</p>
          </div>
        </div>
      </div>
    </div>
